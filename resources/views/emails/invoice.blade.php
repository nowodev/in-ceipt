        ...
        <div class="py-5 border-t">
            <div class="flex justify-between px-4 sm:px-6">
                <div>
                    ...
                    <h1 class="mt-9 text-lg font-bold">{{ $invoice->user->name }}</h1>
                    <h1 class="text-lg font-bold">{{ $invoice->user->address_1 }}</h1>
                    <h1 class="text-lg font-bold">{{ $invoice->user->email }}</h1>
