                    ...
                    <tbody class="bg-white divide-y divide-gray-200" style="--tw-bg-opacity: 1; background-color: rgb(255 255 255 / var(--tw-bg-opacity)); --tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); --tw-divide-opacity: 1; border-color: rgb(229 231 235 / var(--tw-divide-opacity));">
                        <tr class="flex justify-between w-full" style="display: flex; width: 100%; justify-content: space-between;">
                            <td class="px-6 py-4 space-y-3 w-4/5 whitespace-nowrap" style="width: 80%; white-space: nowrap; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px;">
                                <p class="text-sm text-gray-900" style="font-size: 14px; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity));">Account No.: {{ auth()->user()->account_number }}</p>
                                <p class="text-sm text-gray-900" style="font-size: 14px; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity)); --tw-space-y-reverse: 0; margin-top: calc(12px * calc(1 - var(--tw-space-y-reverse))); margin-bottom: calc(12px * var(--tw-space-y-reverse));">Bank Name: {{ auth()->user()->bank_name }}</p>
                                <p class="text-sm text-gray-900" style="font-size: 14px; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity)); --tw-space-y-reverse: 0; margin-top: calc(12px * calc(1 - var(--tw-space-y-reverse))); margin-bottom: calc(12px * var(--tw-space-y-reverse));">Account Name: {{ auth()->user()->account_name }}</p>
                            </td>
