<template>
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <div class="w-3/5 bg-white shadow-lg">
            ...
            <div class="flex justify-between p-4">
                <div>
                    <h6 class="font-bold">Order Date : <span class="text-sm font-medium">{{ receipt.issue_date }}</span>
                    </h6>
                    <h6 class="font-bold">Order ID : <span class="text-sm font-medium">{{ receipt.serial_no }}</span>
                    </h6>
                </div>
                <div class="w-40">
                    <address class="text-sm">
                        <span class="font-bold"> Billed To : </span>
                        {{ receipt.customer.fullname }} <br>
                        {{ receipt.customer.address_1 }} <br>
                        P: {{ receipt.customer.number }}
                    </address>
                </div>
                <div class="w-40">
                    <address class="text-sm">
                ...
                <div class="border-b border-gray-200 shadow">
                    <table class="">
                        ...
                        <tbody class="bg-white">
                            <tr v-for="(rec, index) in receipt.receipt_details" :key="index" class="whitespace-nowrap">
                            ...
                            <tr class="">
                                ...
                                <td class="text-sm font-bold tracking-wider"><b>${{ receipt.sum_total }}</b></td>
                            </tr>
                            <!--end tr-->
                            <tr>
                                <th colspan="3"></th>
                                <td class="text-sm font-bold"><b>Discount</b></td>
                                <td class="text-sm font-bold"><b>{{ receipt.discount }}%</b></td>
                            </tr>
                            <!--end tr-->
                            <tr class="text-white bg-gray-800">
                                <th colspan="3"></th>
                                <td class="text-sm font-bold"><b>Sub Total</b></td>
                                <td class="text-sm font-bold"><b>${{ receipt.sub_total }}</b></td>
                            </tr>
                            <!--end tr-->
            ...
            <div class="flex justify-between p-4">
                <div>
                    ...
                    <ul class="text-xs list-disc list-inside">
                        <li>All accounts are to be paid within 7 days from receipt of receipt.</li>
