        ...
        <CardLayout>
            <div class="flex justify-between p-6 bg-white border-b border-gray-200 sm:px-20">
                <h1 class="text-4xl font-bold text-black">Fill the <span
                        class="underline decoration-double decoration decoration-cyan-500">form</span>
                </h1>
            </div>
            ...
            <div class="p-6 w-full bg-white sm:px-20">
                <div class="mb-4">
                    <div
                        ...
                        <label
                            class="block overflow-hidden h-6 bg-gray-300 rounded-full cursor-pointer toggle-label"
                            for="toggle"></label>
                    </div>
                ...
                <fieldset
                    ...
                    <div>
                        ...
                        <Input v-show="existing === false" id="fullname" v-model="form.fullname"
                            class="w-full" placeholder="John Doe" type="text" />
                    ...
                    <div>
                        ...
                        <Input id="phone" v-model="form.number" class="w-full" min="11"
                            placeholder="08000000000" type="tel" />
                    ...
                    <div>
                        ...
                        <Input id="address" v-model="form.address_1" class="w-full"
                            placeholder="No. X, Somewhere in China town" type="text" />
                ...
                <fieldset
                    ...
                    <div>
                        ...
                        <Input id="issue_date" v-model="form.issue_date" class="w-full"
                            type="date" />
                        <InputError v-if="form.errors.issue_date"
                ...
                <div v-for="(desc, index) in form.info" :key="index">
                    <fieldset
                        ...
                        <legend class="text-lg font-semibold">Item Description {{ index + 1 }}
                        </legend>

                        <div>
                            <Label for="description">Description</Label>
                            <Input id="description" v-model="desc.description" class="w-full"
                        ...
                        <div>
                            ...
                            <Input id="price" v-model="desc.unit_price" class="w-full"
                                placeholder="0000.00" type="number" />
                        ...
                        <div>
                            ...
                            <Input id="quantity" v-model="desc.quantity" class="w-full"
                ...
                <fieldset
                    ...
                    <div>
                        ...
                        <Input id="discount" v-model="form.discount" class="w-full" placeholder="2%"
                            type="number" />
...
export default defineComponent({
    ...
    mounted() {
        ...
        // pass total values to preview
        this.total = {
            total: this.get_total,
            sum_total: this.get_sum_total,
